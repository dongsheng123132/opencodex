...
export const ZH: Record<string, string> = {
  ...
  "Independent from app appearance": "与外壳主题分开",
  "Default": "默认",
  "Deep gray": "深灰",
  "High contrast": "高对比",
  "Light terminal": "浅色终端",
  ...
  "Cursor": "光标",
  "Selection": "选区",
  "Edit ANSI 16 colors": "调整 ANSI 16 色",
  "Hide ANSI 16 colors": "收起 ANSI 16 色",
  "Text contrast": "文字对比度",
  "Restore terminal defaults": "恢复终端默认配色",
  "Only changes xterm colors inside this app. It never edits Claude, Codex, Hermes, or system terminal settings.":
  ...
  "History Ctrl+T": "历史 Ctrl+T",
  "Codex uses an alternate screen. Press Ctrl+T to browse and copy the full transcript.":
    "Codex 使用备用屏幕，按 Ctrl+T 可浏览和复制完整会话记录。",
